...
def evaluate(methods, method_names, data_loader, config, debug=False):
  ...
  for batch_idx in range(tot_num_data):
    ...
    for i, method in enumerate(methods):
      start = time.time()
      T = method.register(xyz0, xyz1,p_image=p_image,q_image=q_image)
      end = time.time()
...
if __name__ == '__main__':
  checkpoint_path = "/home/qwt/code/DeepGlobalRegistration-master-test-modify/outputs/checkpoint_4_0.7575.pth"
