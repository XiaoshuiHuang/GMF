...
class KITTIPairDataset(PairDataset):
  AUGMENT = None
  DATA_FILES = {
      'train': '/home/qwt/code/DeepGlobalRegistration-master-test-modif_posi_Kitti/dataloader/split/train_kitti.txt',
      'val': '/home/qwt/code/DeepGlobalRegistration-master-test-modif_posi_Kitti/dataloader/split/val_kitti.txt',
      'test': '/home/qwt/code/DeepGlobalRegistration-master-test-modif_posi_Kitti/dataloader/split/test_kitti.txt'
  }
  ...
  def __getitem__(self, idx):
    ...
    image_file1 = fname1.replace(".bin", ".png")
