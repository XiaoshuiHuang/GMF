...
# ---- Running Parameters ----
dataset = '3DMatch' # ["3DMatch","Kitti"]
# dataset_path = "/DISK/qwt/pointDSC/FPFH_feat_train"
dataset_path = "/DISK/qwt/pointDSC/FCGF_feat_train"
# dataset_path = "/DISK/qwt/pointDSC/FCGF_Kitti_train"
save_path = "outputs"
descriptor = "fcgf" # ["fcgf","fpfh"]
pretrain_path = ""
batch_size = 16
# ---- Running Parameters ----
...
snapshot_arg.add_argument('--snapshot_dir', type=str, default=f'{save_path}/snapshot/{experiment_id}')
snapshot_arg.add_argument('--tboard_dir', type=str, default=f'{save_path}/tensorboard/{experiment_id}')
snapshot_arg.add_argument('--snapshot_interval', type=int, default=1)
snapshot_arg.add_argument('--save_dir', type=str, default=os.path.join(f'{save_path}/snapshot/{experiment_id}', 'models/'))
...
if dataset == '3DMatch':
    ...
    overlap_path = "/DISK/qwt/pointDSC/overlap"

    data_arg.add_argument('--root', type=str, default=dataset_path)
    data_arg.add_argument('--overlap_path', type=str, default=overlap_path)

    data_arg.add_argument('--descriptor', type=str, default=descriptor, choices=['d3feat', 'fpfh', 'fcgf'])
    ...
    data_arg.add_argument('--downsample', type=float, default=downsample)
...
data_arg.add_argument('--num_workers', type=int, default=batch_size)
...
# pretrain_path = ''
misc_arg.add_argument('--pretrain', type=str, default=pretrain_path)
